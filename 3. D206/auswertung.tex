...
\section{Kompressorleistung}

Für die Berechnung der Kompressorleistung  $N_\text{mech}$ darf eine adiabatische Kompression angenommen wertden.
\begin{align*}
    ...
    \intertext{Desweiteren ist die Kompressionsarbeit die Arbeit, welche verrichtet wird, wenn ein Volumen zu einem anderen komprimiert wird.}
