...
des Wassers $c_w=\SI{4.183}{\kilo\joule\per\kilo\gram\per\kelvin}$ \footnote{Quelle: \url{https://www.chemie.de/lexikon/Spezifische_W\%C3\%A4rmekapazit\%C3\%A4t.html}} nimmt.
...
\newpage
%5e)
\section{Massendurchsatz}
\subsection{Plot und Verdampfungswärme}
...
Mithilfe einer linearen Regression lässt sich nun aus den geploteten Werten für beide Datensätze die Verdampfungswärme $L$ bestimmen.

\begin{align*}
\intertext{$L_1$ bestimmt sich dann aus der Regressionsgeraden des Datensatzes $T_1$ mit Hilfe der Gaskonstante $\symup{R}$.}
y&=mx+n  \\
...
\subsection{Berechnung Massendurchsatz}
