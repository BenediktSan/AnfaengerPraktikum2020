...
\begin{table}[H]
    ...
    \begin{tabular}{ S [table-format=2.0] S [table-format=1.4]@{$\pm{}$} S [table-format=1.4] S [table-format=2.5] @{$\pm{}$} S [table-format=1.3]}
        \toprule
        {$t \mathbin{/} \si{\minute}$} & \multicolumn{2}{c}{ $v_\text{real}$} & \multicolumn{2}{c}{$v_\text{ideal} $} \\
        \midrule
        7	& 2.9479 & 0.0134 &23.03 &0.24  \\
        14	& 2.9413 & 0.0134 &12.63 &0.07  \\
        21	& 2.9347 & 0.0135 &9.46  &0.04  \\
        28	& 2.8802 & 0.0134 &7.97 &0.026 \\
        \bottomrule
        \\
    \end{tabular}
...
Dafür unterliegen sie wesentlich weniger Fluktuationen. Man sieht, dass sie ungefähr einen Wert von $\approx 2,9$ haben, 
...
\footnotetext[4]{Quelle: \url{https://www.chemie.de/lexikon/Universelle_Gaskonstante.html}(Besucht am 30.11.2020)}


\begin{align*}
\intertext{$L$ bestimmt sich dann aus der Regressionsgeraden des Datensatzes $T_2$
 mit Hilfe der Gaskonstante $\symup{R}$ \footnotemark[4].}
\\
\implies L&=(-1) \cdot m \cdot \symup{R}\\
y&=-1718.02083898x+7.3235009\\
\\
\implies L&\approx\SI{14298.66+-734.7}{\joule\per\mol}
\intertext{Die Verdampfungswärme läst sich nun mithilfe der Molaren Masse des Dichloridfluormethan von $\si{Joule\per\mol}$ zu $\si{\joule\per\kilo\gram}$ umrechnen.}
M_{\text{molar}}&=\SI{120.91 e-3}{\kilo\gram\per\mol} \footnotemark[5]\\
\implies L &\approx \SI{118258.7336+-6076.4305}{\joule\per\kilo\gram} 
\end{align*}
\footnotetext[5]{Quelle: \url{https://www.chemie.de/lexikon/Dichlordifluormethan.html}(Besucht am 30.11.2020)}
...
\begin{table}[H]
    ...
    \begin{tabular}{ S [table-format=1.5] S [table-format=1.5] @{$\pm{}$} S}
        \toprule
        {$t \mathbin{/} \si{\minute}$} & \multicolumn{2}{c}{ $\frac{\Delta m}{\Delta t} \mathbin{\scalebox{1.5}{/}} \si{\gram\per\second}$}\\
        \midrule
        7	&-1.48121  & 0.08023\\
        14	&-1.36799  & 0.07410\\
        21	&-1.29101  & 0.06993\\
...
\begin{table}[H]
    \centering
    \begin{tabular}{ S [table-format=2.0] S [table-format=1.6] @{$\pm{}$} S[table-format=1.6]}
        \toprule
        {$t \mathbin{/} \si{\minute}$} & \multicolumn{2}{c}{ $P \mathbin{/} \si{\watt}$} \\
        \midrule
        7	& 0.000664 & 0.000036\\
        14	& 0.000760 & 0.000041\\
        21	& 0.000845 & 0.000046\\
        28	& 0.000868 & 0.000047\\
        \bottomrule
        \\
    \end{tabular}
...
lässt sich vermutlich dadurch erklären, dass in dem Vorgang sehr viel Energie bei der Umwandlung
"verloren" geht.
