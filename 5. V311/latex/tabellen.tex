...
\begin{table}[H]
    ...
    \begin{tabular}{S[table-format=3.3] @{$\pm{}$} S [table-format=1.3]  S [table-format=3.3] @{$\pm{}$} S [table-format=2.3]  }
        \toprule
        \multicolumn{2}{c}{ $ \text{Elektronendichte}_\text{Z,Spule} [\SI{1e24}{\per\meter\cubed}]$ } & \multicolumn{2}{c}{ $ \text{Elektronendichte}_\text{K,Spule} [\SI{1e24}{\per\meter\cubed}]$ }  \\
        \midrule
...
\begin{table}[H]
    ...
    \begin{tabular}{ S [table-format=3.3] @{$\pm{}$} S [table-format=1.3] S [table-format=3.3] @{$\pm{}$} S [table-format=2.3] }
        \toprule
        \multicolumn{2}{c}{ $ \text{Elektronendichte}_\text{Z,Probe} [\SI{1e24}{\per\meter\cubed}]$ } & \multicolumn{2}{c}{ $ \text{Elektronendichte}_\text{K,Probe} [\SI{1e24}{\per\meter\cubed}]$ }\\
        \midrule
...
\begin{table}[H]
    ...
    \begin{tabular}{S[table-format=3.3] @{$\pm{}$} S [table-format=2.3]  S [table-format=2.3] @{$\pm{}$} S [table-format=1.3]  }
        \toprule
        \multicolumn{2}{c}{ $ \text{Beweglichkeit}_\text{Z,Spule}[\si{\ampere\second\squared\per\kilogram}] $ } & \multicolumn{2}{c}{ $ \text{Beweglichkeit}_\text{K,Spule}[\si{\ampere\second\squared\per\kilogram}] $ }  \\
        \midrule
...
\begin{table}[H]
    ...
    \begin{tabular}{ S [table-format=2.3] @{$\pm{}$} S [table-format=1.3] S [table-format=2.3] @{$\pm{}$} S [table-format=1.3] }
        \toprule
        \multicolumn{2}{c}{ $ \text{Beweglichkeit}_\text{Z,Probe} [\si{\ampere\second\squared\per\kilogram}]$ } & \multicolumn{2}{c}{ $ \text{Beweglichkeit}_\text{K,Probe} [\si{\ampere\second\squared\per\kilogram}]$ }\\
        \midrule
        44.033 & 1.667 & 1957.444 & 74.522  \\
