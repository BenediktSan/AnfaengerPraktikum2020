...
Kupfer = np.array([2.80e-2, 2.53e-2, 0.018e-2])
...
U_Zink =1e-3 * np.array([-0.02, 14.13, 27.7, 41.1, 55.5, 68.3, 81.5, 94.7,107.1, 120.3, 133.7])

U_Kupfer =1e-3 * np.array([0, 7.83, 15.54, 23.3, 30.9, 38.6, 46.3, 53.9, 61.5,68.8, 76.5])
