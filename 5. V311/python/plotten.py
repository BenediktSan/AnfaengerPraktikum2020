...
plt.figure()
plt.subplot(2,2,1)
plt.plot(I_s_Zink,unumpy.nominal_values(n_sZink),".",label="Spulestrom n_Zink")
#plt.plot(I_s_Zink,(I_s_Zink*param3[0]+param3[1])*1e3,label="Fit")
plt.xlabel("Stromstärke [A]")
...
plt.subplot(2,2,2)
plt.plot(I_s_Kupfer ,unumpy.nominal_values(n_sKupfer),".",label="Spulestrom n_Kupfer")
#plt.plot(I_s_Kupfer,(I_s_Kupfer*param4[0]+param4[1])*1e3,label="Fit")
plt.xlabel("Stromstärke [A]")
plt.ylabel("Elektronendichte [m^-3]")
plt.legend()
...
plt.subplot(2,2,3)
plt.plot(I_p_Zink,unumpy.nominal_values(n_pZink),".",label="Probestrom n_Zink")
#plt.plot(I_p_Zink,(I_p_Zink*param5[0]+param5[1])*1e3,label="Fit") 
plt.xlabel("Stromstärke [A]")
plt.ylabel("Elektronendichte [m^-3]")
plt.legend()
...
plt.subplot(2,2,4)
plt.plot(I_p_Kupfer ,unumpy.nominal_values(n_pKupfer),".",label="Probestrom n_Kupfer")
#plt.plot(I_p_Kupfer,(I_p_Kupfer*param6[0]+param6[1])*1e3,label="Fit") 
plt.xlabel("Stromstärke [A]")
plt.ylabel("Elektronendichte [m^-3]")
plt.legend()
...
plt.figure()
plt.subplot(2,2,1)
plt.plot(I_s_Zink,unumpy.nominal_values(Z_sZink),".",label="Elektron pro Zink Atom")
#plt.plot(I_s_Zink,(I_s_Zink*param3[0]+param3[1])*1e3,label="Fit")
plt.xlabel("Stromstärke [A]")
...
plt.subplot(2,2,2)
plt.plot(I_s_Kupfer ,unumpy.nominal_values(Z_sKupfer),".",label="Elektron pro Kupfer Atom")
#plt.plot(I_s_Kupfer,(I_s_Kupfer*param4[0]+param4[1])*1e3,label="Fit")
plt.xlabel("Stromstärke [A]")
plt.ylabel("Elektron pro Atom")
plt.legend()
...
plt.subplot(2,2,3)
plt.plot(I_p_Zink,unumpy.nominal_values(Z_pZink),".",label="Elektron pro Zink Atom")
#plt.plot(I_p_Zink,(I_p_Zink*param5[0]+param5[1])*1e3,label="Fit") 
plt.xlabel("Stromstärke [A]")
plt.ylabel("Elektron pro Atom")
plt.legend()
...
plt.subplot(2,2,4)
plt.plot(I_p_Kupfer ,unumpy.nominal_values(Z_pKupfer),".",label="Elektron pro Kupfer Atom")
#plt.plot(I_p_Kupfer,(I_p_Kupfer*param6[0]+param6[1])*1e3,label="Fit") 
plt.xlabel("Stromstärke [A]")
plt.ylabel("Elektron pro Atom")
plt.legend()
...
plt.figure()
plt.subplot(2,2,1)
plt.plot(I_s_Zink,unumpy.nominal_values(tau_sZink),".",label="tau_sZink")
#plt.plot(I_s_Zink,(I_s_Zink*param3[0]+param3[1])*1e3,label="Fit")
plt.xlabel("Stromstärke [A]")
...
plt.subplot(2,2,2)
plt.plot(I_s_Kupfer ,unumpy.nominal_values(tau_sKupfer),".",label="tau_sKupfer")
#plt.plot(I_s_Kupfer,(I_s_Kupfer*param4[0]+param4[1])*1e3,label="Fit")
plt.xlabel("Stromstärke [A]")
plt.ylabel("mittlere Flugzeit [s]")
plt.legend()
...
plt.subplot(2,2,3)
plt.plot(I_p_Zink,unumpy.nominal_values(tau_pZink),".",label="tau_pZink")
#plt.plot(I_p_Zink,(I_p_Zink*param5[0]+param5[1])*1e3,label="Fit") 
plt.xlabel("Stromstärke [A]")
plt.ylabel("mittlere Flugzeit [s]")
plt.legend()
...
plt.subplot(2,2,4)
plt.plot(I_p_Kupfer ,unumpy.nominal_values(tau_pKupfer),".",label="tau_pKupfer")
#plt.plot(I_p_Kupfer,(I_p_Kupfer*param6[0]+param6[1])*1e3,label="Fit") 
plt.xlabel("Stromstärke [A]")
plt.ylabel("mittlere Flugzeit [s]")
plt.legend()
...
plt.figure()
plt.subplot(2,2,1)
plt.plot(I_s_Zink,unumpy.nominal_values(vd_sZink),".",label="vd_sZink")
#plt.plot(I_s_Zink,(I_s_Zink*param3[0]+param3[1])*1e3,label="Fit")
plt.xlabel("Stromstärke [A]")
...
plt.subplot(2,2,2)
plt.plot(I_s_Kupfer ,unumpy.nominal_values(vd_sKupfer),".",label="vd_sKupfer")
#plt.plot(I_s_Kupfer,(I_s_Kupfer*param4[0]+param4[1])*1e3,label="Fit")
plt.xlabel("Stromstärke [A]")
plt.ylabel("Geschindigkeit [m/s]")
plt.legend()
...
plt.subplot(2,2,3)
plt.plot(I_p_Zink,unumpy.nominal_values(vd_pZink),".",label="vd_pZink")
#plt.plot(I_p_Zink,(I_p_Zink*param5[0]+param5[1])*1e3,label="Fit") 
plt.xlabel("Stromstärke [A]")
plt.ylabel("Geschindigkeit [m/s]")
plt.legend()
...
plt.subplot(2,2,4)
plt.plot(I_p_Kupfer ,unumpy.nominal_values(vd_pKupfer),".",label="vd_pKupfer")
#plt.plot(I_p_Kupfer,(I_p_Kupfer*param6[0]+param6[1])*1e3,label="Fit") 
plt.xlabel("Stromstärke [A]")
plt.ylabel("Geschindigkeit [m/s]")
plt.legend()
...
plt.subplot(2,2,2)
plt.plot(I_s_Kupfer ,unumpy.nominal_values(Beweg_sKupfer),".",label="Beweg_sKupfer")
#plt.plot(I_s_Kupfer,(I_s_Kupfer*param4[0]+param4[1])*1e3,label="Fit")
plt.xlabel("Stromstärke [A]")
plt.ylabel("Beweglichleit [As^2/kg]")
plt.legend()
...
plt.subplot(2,2,3)
plt.plot(I_p_Zink,unumpy.nominal_values(Beweg_pZink),".",label="Beweg_pZink")
#plt.plot(I_p_Zink,(I_p_Zink*param5[0]+param5[1])*1e3,label="Fit") 
plt.xlabel("Stromstärke [A]")
plt.ylabel("Beweglichleit [As^2/kg]")
plt.legend()
...
plt.subplot(2,2,4)
plt.plot(I_p_Kupfer ,unumpy.nominal_values(Beweg_pKupfer),".",label="Beweg_pKupfer")
#plt.plot(I_p_Kupfer,(I_p_Kupfer*param6[0]+param6[1])*1e3,label="Fit") 
plt.xlabel("Stromstärke [A]")
plt.ylabel("Beweglichleit [As^2/kg]")
plt.legend()
...
plt.figure()
plt.subplot(2,2,1)
plt.plot(I_s_Zink,unumpy.nominal_values(vT_sZink),".",label="vT_sZink")
#plt.plot(I_s_Zink,(I_s_Zink*param3[0]+param3[1])*1e3,label="Fit")
plt.xlabel("Stromstärke [A]")
...
plt.subplot(2,2,2)
plt.plot(I_s_Kupfer ,unumpy.nominal_values(vT_sKupfer),".",label="vT_sKupfer")
#plt.plot(I_s_Kupfer,(I_s_Kupfer*param4[0]+param4[1])*1e3,label="Fit")
plt.xlabel("Stromstärke [A]")
plt.ylabel("Totalgeschindigkeit [m/s]")
plt.legend()
...
plt.subplot(2,2,3)
plt.plot(I_p_Zink,unumpy.nominal_values(vT_pZink),".",label="vT_pZink")
#plt.plot(I_p_Zink,(I_p_Zink*param5[0]+param5[1])*1e3,label="Fit") 
plt.xlabel("Stromstärke [A]")
plt.ylabel("Totalgeschindigkeit [m/s]")
plt.legend()
...
plt.subplot(2,2,4)
plt.plot(I_p_Kupfer ,unumpy.nominal_values(vT_pKupfer),".",label="vT_pKupfer")
#plt.plot(I_p_Kupfer,(I_p_Kupfer*param6[0]+param6[1])*1e3,label="Fit") 
plt.xlabel("Stromstärke [A]")
plt.ylabel("Totalgeschindigkeit [m/s]")
plt.legend()
...
plt.figure()
plt.subplot(2,2,1)
plt.plot(I_s_Zink,unumpy.nominal_values(mWeg_sZink),".",label="mWeg_sZink")
#plt.plot(I_s_Zink,(I_s_Zink*param3[0]+param3[1])*1e3,label="Fit")
plt.xlabel("Stromstärke [A]")
...
plt.subplot(2,2,2)
plt.plot(I_s_Kupfer ,unumpy.nominal_values(mWeg_sKupfer),".",label="mWeg_sKupfer")
#plt.plot(I_s_Kupfer,(I_s_Kupfer*param4[0]+param4[1])*1e3,label="Fit")
plt.xlabel("Stromstärke [A]")
plt.ylabel("mittlere Weglänge [m]")
plt.legend()
...
plt.subplot(2,2,3)
plt.plot(I_p_Zink,unumpy.nominal_values(mWeg_pZink),".",label="mWeg_pZink")
#plt.plot(I_p_Zink,(I_p_Zink*param5[0]+param5[1])*1e3,label="Fit") 
plt.xlabel("Stromstärke [A]")
plt.ylabel("mittlere Weglänge [m]")
plt.legend()
...
plt.subplot(2,2,4)
plt.plot(I_p_Kupfer ,unumpy.nominal_values(mWeg_pKupfer),".",label="mWeg_pKupfer")
#plt.plot(I_p_Kupfer,(I_p_Kupfer*param6[0]+param6[1])*1e3,label="Fit") 
plt.xlabel("Stromstärke [A]")
plt.ylabel("mittlere Weglänge [m]")
plt.legend()
