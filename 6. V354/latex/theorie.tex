...
\section{Theoretische Grundlagen}
    ...
    Da die Elemente der Schwingkreises in Reihe geschalten sind wird dieser als Serienschwingkreis bezeichnet. Die gesamt Impedanz $r$ berechnet 
    ...
    Die gesamt Impedanz $r_{\symup{S}}$ berechnet sich also zu:
    \begin{equation}
        r_{\symup{S}} = R_{\symup{S}} + j \left(    \omega L - \frac{1}{\omega C} \right) \nonumber
    \end{equation}

    Aufteilung in real und imaginär Teil ergibt:
    \begin{align}
    ...
    Da $X_{\symup{S}}$ nicht von $\omega$ abhängig ist schneidet die Ortskurve die x-Achse an der Stelle $R_{\symup{S}}$. Der Scheinwiderstand 
    ...
    gegen $\infty$.
        ...
        Die Impedanz $r_{\symup{p}}$ Parallelschwingkreises berechnet sich zu:
    ...
    und somit der Scheinwiderstand zu:
    \begin{equation}
