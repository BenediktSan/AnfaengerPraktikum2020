...
\end{equation}
gelten muss.\\
Dieser Term, das Reziprok Widerstands, wird als elektrische Leitfähigkeit $S$ bezeichnet. Wie aus \refeq{eqn:ohm1} ersichtlich bildet
...
\begin{align}
  ...
  E_F &= \frac{\symup{h}^2}{2 \cdot \symup{m_0}}\sqrt{\left(\frac{3n}{8\pi}\right)^2} \label{eqn:E_F}
\end{align} 
...
Dies kann zum Beispiel bei zweiwertigen Metallen, also Metallen die zwei Wasserstoffatome binden könnten, vorkommen.
