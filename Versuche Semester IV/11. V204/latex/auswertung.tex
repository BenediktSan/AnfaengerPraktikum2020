\section{Auswertung}
    ...
    \subsection{Statische Methode}
      ...
      \begin{figure}[H]
          \centering
          \includegraphics[width=0.4\textwidth]{build/plots/stat_plot.pdf}
      ...
      \begin{figure}[H]
        \centering
        \includegraphics[width=0.4\textwidth]{build/plots/plot_diff.pdf}
    ...
    \subsection{Dynamische Methode}
      ...
      \subsubsection{Messingstab (breit)}
        ...
        \begin{figure}[ht]
          \centering
          \includegraphics[width=0.4\textwidth]{build/plots/plot_messing.pdf}
      ...
      \subsubsection{Edelstahlstab}
        ...
        \begin{figure}[ht]
          \centering
          \includegraphics[width=0.4\textwidth]{build/plots/plot_edelstahl.pdf}
